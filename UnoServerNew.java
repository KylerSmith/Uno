...
//============================================================
		...
		private void play(Player player, Player opponent, DataInputStream fromPlayer, 
			...
			if (receivedStatus == PLAYCARD) {
				...
				// checks if a certain action was played
				checkAction(player, opponent, indexReceived, drawDeck, toOpponent);
...
//============================================================
		public void checkAction(Player player, Player opponent, int index, Unodeck d, DataOutputStream toOpponent) {
			try {
